...
class MainTest(TestCase):
    def setUp(self):
        self.experience = Experience.objects.create(
            ...
            description="Supported practical sessions by supervising and grading student work, developed assignments and practical exercises, and proctored examinations.",
            category="part-time",
        )
